...
const createSlider = () => {
  ...
  if (duration < 0) {
    alert("Warning: If you set a negative duration, it will convert to a positive duration for better user experience.");
...
const loadingToggleSpinner = () => {
  ...
  imageSection.classList.toggle("invisible");
}